...
Public Class DecafCoffeeForm
'***************************************************************************************************
'This procedure will use a do loop to populate the combo box with coffee brands when the form loads
'***************************************************************************************************
    Private Sub DecafCoffeeForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                'declare a loop counter
        Dim intCounter As Integer = 1
                'populate the combo box with coffee brands
        Do While intCounter <= 5
            cboBrand.Items.Add("Decaf " & intCounter.ToString())
            intCounter += 1
        Loop
...
'***************************************************************************************************
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Const decONE_POUND As Decimal = 10D
        Const decTWO_POUNDS As Decimal = 18D
        Const decTEN_POUNDS As Decimal = 85D
